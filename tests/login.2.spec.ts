...
test('loads the login page 2 @happy', async ({ page }, testInfo) => {
  await sauceVisualCheck(page, testInfo, "Before Login");
});

test('should be able to login with standard user 2 @happy', async ({ page }, testInfo) => {
...
test('should not be able to login with a locked user 2', async ({ page }, testInfo) => {
